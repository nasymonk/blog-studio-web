...
describe('useEditor', () => {
  ...
  it('returns an object with all expected properties', async () => {
    ...
    expect(typeof result.execStrikethrough).toBe('function')
    expect(typeof result.execBlockquote).toBe('function')
    expect(typeof result.execUnorderedList).toBe('function')
    expect(typeof result.execOrderedList).toBe('function')
    expect(typeof result.execTaskList).toBe('function')
    expect(typeof result.execTable).toBe('function')
    expect(typeof result.execHr).toBe('function')
