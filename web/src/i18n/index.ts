...
const dict = {
  zh: {
    ...
    preset: '预设',
    presetDefault: '默认',
    presetTypewriter: '打字机',
    presetCompact: '紧凑',
    fontFamilySystem: '系统',
    fontFamilyMono: '等宽',
    fontFamilySerif: '衬线',
    codeThemeOneDark: 'One Dark',
  ...
  en: {
    ...
    healthLoadFailed: 'Failed to load health check. Please retry.',
    refresh: 'Refresh',
